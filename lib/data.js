...
export const projects = [
  ...
  {
    id: 'purpal',
    title: 'Purpal — AI Product Management Agent',
    period: 'Jan 2026 – Present',
    description: [
      'An autonomous AI product manager that runs competitive market intelligence, product discovery, and PRD generation end-to-end — collapsing hours of manual research into a single query.',
      'Multi-step LLM orchestration through LangChain, with dynamic RAG context retrieval and structured output parsing, producing grounded, citation-backed product specs at scale.',
      'The agentic loop combines tool-use, live web-search integration, and iterative self-refinement to turn scattered market signals into actionable feature recommendations and prioritized roadmaps.',
    ],
    stack: ['React', 'Next.js', 'Python', 'FastAPI', 'LangChain', 'RAG', 'OpenRouter', 'Supabase', 'Cloud Run'],
    links: {
      live: 'https://purpal.ai',
    },
    images: PROJECT_IMAGES.purpal,
  },
  {
    id: 'parkPortal',
...
export const site = {
  ...
  tagline: 'Full Stack Engineer · Baltimore, MD',
